 ...
 *
 * The top-of-page region: a Header Bar (global search + notifications + profile),
 * a Title bar (Back, Title, breadcrumb and Large action Buttons) and the Control
 * Set's Tabs control (each tab separated by a right divider, last tab excepted).
 * Composes Text Input, Button and Control Set; the breadcrumb and notifications
 * dot are local to this component.
 */
...
figma.connect(
  ...
  <div class="header-controls__bar">
    ...
    <div class="header-controls__actions">
      ...
      <button class="header-controls__profile" type="button" aria-label="Account">
        <span class="header-controls__avatar">U</span><!-- chevron -->
      </button>
    </div>
  </div>
  <div class="header-controls__title-bar">
    <div class="header-controls__title-left">
      <button class="btn btn--secondary btn--large btn--rounded" type="button"><!-- ← -->Back</button>
    ...
    <div class="header-controls__title-actions">
      <button class="btn btn--secondary btn--large btn--rounded" type="button"><!-- + -->Button</button>
      <button class="btn btn--primary btn--large btn--rounded" type="button"><!-- + -->Button</button>
    </div>
  </div>
